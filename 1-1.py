...
Label(my_window, text='欢迎来到、\n智能学生个人信息考试等级表格化系统\n使用前,请关闭WPS等软件', width=100, font='Arial,200').place(x=10, y=50)
...
stu_menu.add_command(label='添加', command=pop_add_stu_sport_win)
stu_menu.add_command(label='查询', command=pop_query_stu_sport_win)
menu_bar.add_cascade(label='信息', menu=stu_menu)

stu_menu = Menu(menu_bar)

score_menu.add_command(label='添加', command=pop_add_stu_grades_win)
score_menu.add_command(label='查询', command=pop_query_stu_grades_win)
